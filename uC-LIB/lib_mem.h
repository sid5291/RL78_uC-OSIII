...
#define  LIB_MEM_ERR_HEAP_EMPTY                        10210u   /* Heap seg empty; i.e. NO avail mem in heap.           */
#define  LIB_MEM_ERR_HEAP_OVF                          10211u   /* Heap seg ovf;   i.e. req'd mem ovfs rem mem in heap. */
#define  LIB_MEM_ERR_HEAP_NOT_FOUND                    10215u   /* Heap seg NOT found.                                  */
...
#define  MEM_VAL_COPY_GET_INTU_LITTLE(addr_dest, addr_src, val_size)    do {                                                                                  \
                                                                            ...
                                                                            CPU_SIZE_T  _j;                                                                   \
                                                                                                                                                              \
                                                                            for (_i = 0, _j = (val_size) - 1; _i < (val_size); _i++, _j--) {                  \
