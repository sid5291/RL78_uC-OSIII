...
extern const uint8_t * const FontHelvr10_table[256];
extern const uint8_t * const Bitmaps_table[256];
extern const uint8_t * const Font8x16_table[256];
extern const uint8_t * const Font8x8_table[256];
extern const uint8_t * const FontWinFreeSystem14x16_table[256];
extern const uint8_t * const Fontx5x7_table[256];
extern const uint8_t * const Fontx6x13_table[256];
extern const uint8_t * const Logos_table[256];
...
******************************************************************************/
typedef enum {
    GLYPH_FONT_8_BY_8,                  // Available
    GLYPH_FONT_8_BY_16,                 // Not Compiled in Library
    GLYPH_FONT_5_BY_7,                  // Available
    GLYPH_FONT_6_BY_13,                 // Not Compiled in Library
