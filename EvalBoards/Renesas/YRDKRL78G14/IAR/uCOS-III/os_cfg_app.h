...
*/
                                                            ...
                                                            /* --------------------- MISCELLANEOUS ------------------ */
#define  OS_CFG_MSG_POOL_SIZE              5u               /* Maximum number of messages                             */
...
#define  OS_CFG_TASK_STK_LIMIT_PCT_EMPTY  10u               /* Stack limit position in percentage to empty            */
                                                            ...
                                                            /* ---------------------- IDLE TASK --------------------- */
#define  OS_CFG_IDLE_TASK_STK_SIZE       64u 		//128u               /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_TICK_WHEEL_SIZE            3u               /* Number of 'spokes' in tick  wheel; SHOULD be prime     */
...
#define  OS_CFG_TMR_WHEEL_SIZE             5u               /* Number of 'spokes' in timer wheel; SHOULD be prime     */
